...
function previewSection(obj){
    ...
    if(row && action!=null){
        ...
        switch (action.value){
            ...
            content.innerHTML += "<div class='card "+classes+" white-bg shadow small-side-padding  small-padding rounded'><div class='max-width max-height'><div id='card-edit-container'  class='card-edit-buttons float-right'></div></div></div>";
            break;
            case 'image':
                var classes = 'small-margin hide-overflow ';
                var url = document.getElementById('media-url').value;
                var width = document.getElementsByName('width');
                width.forEach(className => {
                    if (className.checked) {
                ...
                var height = document.getElementsByName('height');
                    ...
                    content.innerHTML += "<div class='"+classes+"'><img class='max-width' src='assets/media/images/"+url+"'>";
            break;
            case 'video':
            var classes = '';
            var url = document.getElementById('media-url').value;
            ...
            if(type=='contact'){
                ...
                string += "<input class='form-input text-box extra-small-padding block border rounded' type='text' placeholder='What is your name?' name='form-input[]'/>";
