<div id="row-footer" class="primary-bg alternative-txt"><!--  div-slant-top"> -->
    <div id="quick-links-panel">
        ...
        <div class="quick-links">
            <ul>SOCIAL MEDIA
                <a href="http://www.facebook.com/goarmoured"><li>Facebook</li></a>
                <a href="http://www.twitter.com/goarmoured"><li>Twitter</li></a>
                <a href="http://www.linkedin.com/company/goarmoured"><li>LinkedIn</li></a>
            </ul>
        </div>
    </div>
