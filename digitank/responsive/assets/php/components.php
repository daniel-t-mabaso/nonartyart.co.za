<?php
    function createCoursesCourseCard($title, $shortDescription, $location, $price,$age, $time, $image){
        if($title=="_blank_"){
            echo "<div class='blank-course-card courses-courses-course-details float-left horizontal-margin-15'><div class='courses-course-image-dummy'></div></div>";
        }
        else{
                ...
                <div class='courses-course-details-panel'>
                    ...
                    <div class='courses-course-details-bottom'>
                        ...
                        <div class='width-230 center height-30 line-height-30 center-txt'>
                            <div class='rounded pointer padding-2 orange-txt-gradient-1 float-left' onclick='toggleCoursesPopUp(this);'><div class='border-1 padding-3 rounded size-20'><img src='./assets/media/svg/info_icon.svg' alt='Information Icon' height='15px'></div></div>
